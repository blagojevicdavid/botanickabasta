...
namespace BotanickaBasta
{
    public class Bastovan
    {
        ...
        public ObservableCollection<Biljka> zaduzeneBiljke { get; set; } = new();
        ...
        public Bastovan (string ime, string prezime, int id, string telefon)
        {
            ...
            //this.zaduzeneBiljke = new ObservableCollection<Biljka> ();
        }
        ...
        //public ObservableCollection<Biljka> ZaduzeneBiljke { get { return zaduzeneBiljke; }  set { zaduzeneBiljke = value; } }
